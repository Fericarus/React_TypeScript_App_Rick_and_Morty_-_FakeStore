# React TypeScript App – Rick and Morty + FakeStore

Aplicación construida con **React + TypeScript** que incluye autenticación, rutas protegidas, consumo de APIs públicas, manejo de estado con Zustand, almacenamiento cifrado y cierre de sesión por inactividad.

---

## **Características**

- Autenticación con validaciones y persistencia cifrada
- Cierre de sesión automático tras 5 minutos de inactividad
- Rutas protegidas con `react-router-dom`
- Consumo de:
  - Rick and Morty API
  - FakeStore API
- CRUD de productos (crear, ver listado y detalle)
- Página de drag & drop de imágenes con preview
- Validaciones en formularios con `yup` + `react-hook-form`
- Estado global con **Zustand**
- Estilos con **SCSS Modules**
- Separación de vistas, servicios, hooks y store
...
Para acceder al sistema puedes usar los siguientes datos:

* **Usuario:** `test@example.com`
* **Contraseña:** `Test@123`

> La sesión expira automáticamente si no hay interacción durante 5 minutos.
>
